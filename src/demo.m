...
function [fidu_XY,frontal_raw,frontal_sym,hardsym_images]=demo(I_Q,landmarker,file_path,landmark_detections)
addpath calib
frontal_raw = [];
frontal_sym = [];
...
fidu_XY = [];
[Model3D,fidu_XY] = facial_feature_detection(detector,I_Q,file_path,landmark_detections);
if isempty(fidu_XY)
...
frontal_sym = imresize(frontal_sym,[150 150]);
frontal_raw = imresize(frontal_raw,[150 150]);
